...
1. Enter your **future value** - the expected or known value at the end of the period
2. Enter your **present value** - the current value or initial investment amount
3. Enter the **number of years** - the time period between the present and future value
4. The calculator instantly shows the implied annual discount rate
...
Use the [IRR Calculator](/tools/irr-calculator) when you have a series of cash flows over multiple periods and want to find the rate that makes NPV equal to zero.
...
Use the [NPV Calculator](/tools/npv-calculator) to calculate net present value using a discount rate assumption as the input.

## Related calculations

Once you know your discount rate, you may also want to:

- Use the [NPV Calculator](/tools/npv-calculator) to calculate net present value using the discount rate
- Use the [IRR Calculator](/tools/irr-calculator) to calculate the internal rate of return from a series of cash flows
- Use the [Investment Return Calculator](/tools/investment-return-calculator) to calculate return on a specific investment
- Use the [Annual Growth Rate Calculator](/tools/annual-growth-rate-calculator) to calculate CAGR - mathematically equivalent to this calculation
