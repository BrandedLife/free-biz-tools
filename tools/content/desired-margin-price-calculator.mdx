...
- **Markup-based pricing** — adds a percentage of cost to arrive at selling price. Selling Price = Cost × (1 + Markup%). A 40% markup on a 30 cost gives a 42 selling price.
...
Because margin is calculated as a proportion of revenue, while markup is calculated as a proportion of cost. Selling Price = Cost ÷ (1 − Margin%) for margin-based pricing. Selling Price = Cost × (1 + Markup%) for markup-based pricing.
