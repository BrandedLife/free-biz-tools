...
**Bundle Price = Total Item Prices × (1 − Bundle Discount %)**
...
- Bundle price = **120 × (1 − 0.15)**
- Bundle price = **120 × 0.85**
- Bundle price = **102**
...
Bundle Price = Total Item Prices × (1 − Bundle Discount %). Multiply the total value of all items by one minus the discount percentage.
