...
export default function TakealotFeeCalculator() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div>
        <label className="mb-1 block text-sm font-medium text-gray-700">Takealot Fee (%)</label>
        <input type="number" value={feePercentage} onChange={(e) => setFeePercentage(e.target.value)} className="input-premium" placeholder="Enter Takealot fee percentage" />
      </div>

      <div className="result-premium">
        <p className="text-sm text-gray-600">Estimated Takealot Fee</p>
